  ...
  const projects = [
    {
      ...
      description:
        "Sitio web moderno y responsivo para empresa de servicios logísticos, CAMET E.I.R.L.",
      images: [projectWeb, projectWeb1, projectWeb2, projectWeb3, projectWeb4],
    ...
    },
    {
      ...
      description:
        "Sistema empresarial completo para gestión de inventarios ycontrol de stock en tiempo real.",
      images: [
        projectSystem1,
        projectSystem1_1,
        projectSystem1_2,
    ...
    },
    {
      ...
      description:
        "Sistema de automatización para optimizar flujos de trabajo empresariales y generar reportes automatizados.",
      images: [
        projectSystem2,
        projectSystem2_1,
        projectSystem2_2,
          ...
          {projects.map((project, index) => {
            ...
            return (
              <AnimatedSection
                ...
                delay={200 + index * 250}
              >
                <Card className="group overflow-hidden shadow-soft hover:shadow-card transition-all duration-500 hover:-translate-y-2 border-0 h-full">
                  ...
                  <CardContent className="space-y-4">
                    {/* Technologies */}
                    <div>
                      <h4 className="text-sm font-roboto font-semibold text-primary mb-2">
                        Tecnologías
                      </h4>
        ...
        <DialogContent className="max-w-5xl w-full h-[90vh] p-0 bg-black/95 border-gray-800">
          <DialogHeader className="absolute top-4 left-6 z-10">
            <DialogTitle className="text-white text-lg font-semibold">
              {modalProject?.title} - Imagen {modalImageIndex + 1} de{" "}
