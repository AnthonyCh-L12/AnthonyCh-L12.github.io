  ...
  const stats = [
    {
      number: "23",
      label: "Años",
      description: "Joven y apasionado por la tecnología",
    },
  ...
  const values = [
    {
      ...
      title: "Precisión",
      description:
        "Cada proyecto se desarrolla con atención meticulosa a los detalles y requisitos específicos.",
    },
    {
      icon: Lightbulb,
      title: "Innovación",
      description:
        "Utilizo las últimas tecnologías para crear soluciones modernas y eficientes.",
    },
    {
      icon: Award,
      title: "Calidad",
      description:
        "Código limpio, escalable y mantenible que garantiza resultados duraderos.",
    },
  ];
          ...
          <AnimatedSection animation="fade-in-left" className="space-y-8">
            <div className="space-y-4">
              ...
              <AnimatedSection animation="fade-in-up" delay={400}>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Como freelancer, me especializo en crear aplicaciones web,
                  sistemas empresariales y automatizaciones que ayudan a los
                  negocios a optimizar sus procesos y alcanzar sus objetivos.
                </p>
              </AnimatedSection>
            </div>
            ...
            <AnimatedSection animation="scale-in" delay={600}>
              <div className="relative p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg border-l-4 border-blue-400 backdrop-blur-sm">
                <blockquote className="text-lg font-medium text-white italic">
                  "La tecnología es más poderosa cuando convierte tareas
                  complejas en soluciones simples y prácticas."
                </blockquote>
              </div>
            </AnimatedSection>
                ...
                <div className="space-y-4">
                  {values.map((value, index) => (
                    ...
                    >
                      ...
                      <div>
                        <h4 className="font-roboto font-semibold text-white">
                          {value.title}
                        </h4>
          ...
          >
            {stats.map((stat, index) => (
              <AnimatedSection
                ...
                delay={300 + index * 150}
              >
                <Card className="text-center shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:-translate-y-2 border-0 bg-gray-800/50 backdrop-blur-sm border border-gray-700/50">
