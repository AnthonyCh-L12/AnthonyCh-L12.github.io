...
const HeroSection = () => {
  ...
  return (
    <section id="inicio" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 pt-16">
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground font-roboto leading-relaxed">
                ...
                <span className="text-secondary font-semibold">soluciones web</span>,{" "}
                <span className="text-secondary font-semibold">sistemas a medida</span> y{" "}
                <span className="text-secondary font-semibold">automatización empresarial</span>.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-8 pt-4">
              <div className="text-center">
                <div className="text-2xl font-poppins font-bold text-primary">3+</div>
                <div className="text-sm text-muted-foreground">Proyectos</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-poppins font-bold text-primary">2+</div>
                <div className="text-sm text-muted-foreground">Años Exp.</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-poppins font-bold text-primary">100%</div>
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-20 h-20 hero-gradient rounded-full flex items-center justify-center shadow-card">
                <div className="text-white font-poppins font-bold text-lg">23</div>
              </div>
            </div>
          </div>
        </div>
